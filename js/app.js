 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            var blogSliders = document.querySelectorAll(".blog__slider");
            if (blogSliders) blogSliders.forEach((function(blogSlider) {
                new swiper_core_Swiper(blogSlider, {
                    modules: [ Navigation, freeMode, Mousewheel ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 0,
            ...
            if (document.querySelector(".product-gallery__slider")) {
                ...
                function scrollActiveThumbIntoView() {
                    const activeThumb = document.querySelector(".product-gallery__thumbs .swiper-slide-thumb-active");
                ...
                function initSwipers() {
                    ...
                    if (window.innerWidth >= 992) {
                        galleryThumbs = new swiper_core_Swiper(".product-gallery__thumbs", {
                            slidesPerView: 6,
                            watchOverflow: true,
                            spaceBetween: 8
                        });
                    ...
                    galleryMain = new swiper_core_Swiper(".product-gallery__slider", swiperParams);
...
***************************************************************************** */
        ...
        if (window.innerWidth > 991.98) {
            ...
            if (dataHover) dataHover.forEach((dropdown => {
        ...
        var manufacturersWrapper = document.querySelector(".manufacturers__wrapper");
        if (manufacturersWrapper) {
            function animateManufacturers() {
                const elements = document.querySelectorAll(".manufacturers__link");
                ...
                setInterval(applyAnimation, 4e3);
            }
            document.addEventListener("DOMContentLoaded", animateManufacturers);
        }
        ...
        if (productPage) {
            window.addEventListener("scroll", (function() {
                if (window.innerWidth > 991.98) {
                    var productSize = document.querySelector(".product-info__bottom");
        ...
        window.addEventListener("DOMContentLoaded", (event => {
            if (document.querySelector(".header")) setTimeout((function() {
                ...
                const header = document.querySelector("header").offsetHeight - 2;
